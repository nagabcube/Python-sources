...
DATABASE    = "W:/Balaton/CDF/netcdf_forecast.db"
JDBC_URL    = "jdbc:sqlite:%s"  % DATABASE
JDBC_DRIVER = "org.sqlite.JDBC"
TBL_QUERY   = '''SELECT * FROM dss_forecast'''
...
try :
    try :
        myDss  = HecDss.open("W:/Balaton/CDF/Balaton-forecast.dss")
        ...
        while rSet.next():
            ...
            if cnt == 4023:
                start = HecTime("10MAY2012", "0000")
                tsc.fullName = "/BALATON/%s/PRECIP-INC//15MIN/OBS/" % loc
                tsc.interval = 15
